...
module.exports = {
  ...
  networks: {
    development: {
      ...
      gas: 6012388 // TODO change string->byte32. The gas usage increased due to changes for QSP-425. One suggestion for decreasing the gas is to change string to bytes32.
    },
    dev: {
      provider:  function() {
