...
module.exports = {
  ...
  networks: {
    development: {
      ...
      gas: 6000000 // TODO change string->byte32. Th gas usage increased due to changes for QSP-425. One suggestion for decreasing the gas is to change string to bytes32.
    },
    stage_dev: {
